...
output_xml_location = fr"C:\Users\Error\Desktop\OEMER\XML Files\TestChecker.musicxml"
...
while not isValidXML:
	...
	if consec == 30 or (cv2.waitKey(33) & 0xFF == ord('f')): # adjust waitkey() to adjust frame rate
		...
		if cv2.waitKey(0) & 0xFF == ord('g'):		# adjust waitkey() to adjust frame rate
			...
			#output_location = fr"C:\Users\Error\Desktop\OEMER\PNG Files\TestChecker.png"
			...
			#subprocess.call("C:\\Users\\Edward\\arc-piano-hand\\perception\\img2mxl.bbbbbbbpy",shell=True)
